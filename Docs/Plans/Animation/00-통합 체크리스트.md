...
- [ ] `VATAnimationState` (Shared, GhostField: CurrentClipIndex + AnimStartTime)
...
- [ ] 클립 전환 → SoundType 매핑 규칙 (근접/원거리 구분: RangedUnitTag)
...
│   │   ├── Components/Animation/VATAnimTarget.cs
│   │   ├── Components/Animation/PreviousClipIndex.cs
