...
| `Docs/Plans/Logging/로깅 Tier2 ClickHouse Grafana.md` | Tier 2 ClickHouse + Grafana 인프라 계획 (테이블, MV, 대시보드, 알림) |
| `Docs/Plans/Logging/로깅 시스템 구축 계획.md` | 전체 로깅 시스템 구축 계획서 |
...
| `Docs/Systems/코드베이스 구조.md` | `Shared/Logging/` 폴더 항목 추가 |
...
1. **Tier 2 (ClickHouse + Grafana)**: Vector Agent 설정 → ClickHouse 전송 → Grafana 대시보드
   - 상세: `Docs/Plans/Logging/로깅 Tier2 ClickHouse Grafana.md`
